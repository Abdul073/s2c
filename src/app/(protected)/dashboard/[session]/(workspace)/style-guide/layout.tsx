...
import { Hash, LayoutGrid, Type } from "lucide-react";
      ...
      <div className="mt-36 container mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <div>
          <div className="flex flex-col lg:flex-row gap-4 lg:gap-5 items-center justify-between">
            ...
            <TabsList className="grid w-full sm:w-fit h-auto grid-cols-3 rounded-full backdrop-blur-xl bg-white/[0.08] border-white/[0.12] saturate-150 p-2">
              {tabs.map((tab) => {
                return (
                  <TabsTrigger
                    key={tab.value}
