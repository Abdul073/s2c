  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-3 p-6 fixed top-0 left-0 right-0 z-50">
        ...
        <div className="flex items-center gap-2 backdrop-blur-xl bg-white/[0.08] border border-white/[0.12] rounded-full p-2 saturate-150">
          {tabs.map((t) => (
            <Link
              ...
              href={t.href}
              className={[
                "group inline-flex gap-2 rounded-full px-4 py-2 text-sm transition",
            ...
            >
              <span
                className={
                  `${params}?project=${projectId}` === t.href
                    ? "opacity-100"
      ...
      <div className="flex items-center gap-4 justify-end">
        ...
        <Button
          variant="secondary"
          className="rounded-full h-12 w-12 flex items-center justify-center backdrop-blur-xl bg-white/[0.08] border-white/[0.12] saturate-150 hover:bg-white/[0.12]"
        >
